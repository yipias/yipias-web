      ...
      <main className="privacidad-page">
        <div className="container privacidad-container">
          ...
          <div className="footer-checkbox">
            ...
            />
            <label htmlFor="privacidadCheckbox">He leído y acepto la Política de Privacidad y autorizo el tratamiento de mis datos personales exclusivamente para fines operativos según la Ley N.º 29733.</label>
          </div>
        </div>
      </main>
      <Footer />
