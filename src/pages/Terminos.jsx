    ...
    <>
      ...
      <main className="terminos-page">
        <div className="container terminos-container">
          ...
          <p>YipiAs podrá celebrar contratos específicos con empresas para la prestación de servicios de movilidad ejecutiva y empresarial. Estos podrán incluir facturación consolidada mensual, tarifas especiales, acuerdos de nivel de servicio (SLA), soporte prioritario y condiciones operativas particulares. En caso de existir contrato corporativo específico, sus disposiciones prevalecerán sobre los presentes Términos en lo aplicable. La empresa cliente asume responsabilidad solidaria por los servicios solicitados por sus usuarios autorizados.</p>
          ...
          {/* CHECKBOX PARA VOLVER AL INICIO */}
          <div className="footer-checkbox">
            ...
            />
            <label htmlFor="volverCheckbox">He leído y acepto los Términos y Condiciones. Al marcar, seré redirigido al inicio.</label>
          </div>
        </div>
      </main>
      <Footer />
